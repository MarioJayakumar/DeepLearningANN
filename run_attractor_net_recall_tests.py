...
# p1 = parse_recall_task_perf("data/graph_sources/alexnet_recall_task_trial3.txt")
# p2 = parse_recall_task_perf("data/graph_sources/alexnet_recall_task_trial2.txt")
# p3 = parse_recall_task_perf("data/graph_sources/alexnet_recall_task_trial1.txt")
...
run_alexnet_ann_recall_test_simulation_trial4()